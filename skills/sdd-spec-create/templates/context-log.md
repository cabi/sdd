...
### Initial Request
<!-- User's original description will be captured here -->
...
### Goals Identified
<!-- Auto-populated from Q&A - what we're trying to achieve -->

### Constraints Discovered
<!-- Auto-populated from Q&A - what limits our choices -->
...
### Options Considered
<!-- Alternative approaches discussed but not decided -->

### Risks Identified
<!-- Potential problems and their mitigations -->

### Domain Knowledge
<!-- Relevant context, background, history -->
